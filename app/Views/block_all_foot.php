    ...
    <!-- Metronic 5: JS Here -->
    <script src="<?=$short_root?>assets/metronic-v5.1/base/vendors.bundle.js" type="text/javascript"></script>
    <script src="<?=$short_root?>assets/metronic-v5.1/demo5/scripts.bundle.js" type="text/javascript"></script>
